...
| SPC m  w | Work      | work.org      | Notes liées au travail               | * TODO Envoyer le rapport\n 2025-12-08 Tue 14:32          |
| SPC m  s | School    | school.org    | Notes scolaires ou devoirs           | * TODO Préparer le devoir de maths\n 2025-12-08 Tue 14:33 |
| SPC m  j | Journal   | journal.org   | Entrée de journal organisée par date | * Réflexion du jour\nEntered on 2025-12-08 Tue 14:34      |
|----------+-----------+---------------+--------------------------------------+-----------------------------------------------------------|
*** Pour timestamp
| Élément                  | Commande / Template                      | Description / Usage                                                                           |
|--------------------------+------------------------------------------+-----------------------------------------------------------------------------------------------|
| Timestamp actif          | C-c .                                    | Insère un timestamp actif <YYYY-MM-DD> ou <YYYY-MM-DD HH:MM>. Apparaît dans l’agenda.         |
| Timestamp inactif        | C-c !                                    | Insère un timestamp inactif [YYYY-MM-DD]. Référence historique, n’apparaît pas dans l’agenda. |
| Déplacer timestamp actif | S-<left> / S-<right> / S-<up> / S-<down> | Déplace la date du timestamp actif d’un jour ou d’un mois.                                    |
| Deadline                 | C-c C-d                                  | Définit la date limite de la tâche. Apparaît dans l’agenda avec rappel.                       |
| Schedule                 | C-c C-s                                  | Définit la date de début de la tâche. Apparaît dans l’agenda à partir de cette date.          |
| Intervalle               | C-c C-x C-i                              | Insère un intervalle de dates <2025-12-08 10:00-12:00>.                                       |
|--------------------------+------------------------------------------+-----------------------------------------------------------------------------------------------|
...
| Commande            | Action                | Description                                        |
|---------------------+-----------------------+----------------------------------------------------|
| C-c c               | Créer un bookmark     | Ajoute un signet à la position courante            |
| C-c a               | Aller à un bookmark   | Saute vers un signet existant                      |
