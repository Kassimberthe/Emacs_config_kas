...
#+RESULTS:
| (lambda nil (setq tab-width 4) (setq indent-tabs-mode nil)) | doom-modeline-env-setup-python |
...
#+RESULTS:
| python-docstring-mode | sphinx-doc-mode | elpy-mode | (lambda nil (setq tab-width 4) (setq indent-tabs-mode nil)) | doom-modeline-env-setup-python |
...
#+RESULTS:
| lambda | nil | (ws-butler-mode -1) | (visual-line-mode) |
