...
|--------+-----------+------------------------------------------|
| 0  (^) | C-a (M-m) | aller au debut de la ligne (sans espace) |
...
| Visual | Description                                   |
|--------+-----------------------------------------------|
| V      | selectionner ligne par ligne                  |
...
* Clique
** Activer la synchronisation entre emacs et le presse-papiers système
#+begin_src emacs-lisp
...
** Activer la synchronisation entre evil et le presse-papiers système
#+begin_src emacs-lisp
(setq select-enable-clipboard t)
(setq select-enable-primary t)
(setq save-interprogram-paste-before-kill t)
